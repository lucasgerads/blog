...
plt.ylabel('Cases')
plt.savefig(targetDir + 'cases.png')
plt.clf()
...
plt.savefig(targetDir + 'cases_log.png')
plt.clf()
...
plt.savefig(targetDir + 'deaths.png')
plt.clf()
...
plt.savefig(targetDir + 'year.png')
plt.clf()
...
plt.bar(unique, counts)
plt.xlabel(targetDir + 'Gender', fontsize=12)
...
plt.savefig(targetDir + 'gender.png')
plt.clf()
...
file = open(targetDir + "index.md", "w", encoding='utf8',) 
file.write(text) 
file.close() 